...
@OptionsPanelController.SubRegistration(
        location = "Html5",
        displayName = "#AdvancedOption_DisplayName_Minification",
        keywords = "#AdvancedOption_Keywords_Minification",
...
public final class MinificationOptionsPanelController extends OptionsPanelController {
    ...
    private MinificationPanel getPanel() {
        if (panel == null) {
            panel = new MinificationPanel(this);
        }
        return panel;
    }
